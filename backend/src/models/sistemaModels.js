...
async function marcarDiaConcluido(userId, streakAtual = 0, melhorStreak = 0, data = 'CURDATE()') {
    const instrucaoSQL = `
...
async function buscarStreak(userId) {
    const instrucaoSQL = `
...
async function adicionarXp(userId, quantidade, fonte, data) {
    const instrucaoSQL = `
